...
| [Токсичные комментарии с BERT](https://github.com/agamai/Portfolio/blob/main/Toxicity_bert/toxic_bert.ipynb) | Интернет-магазину нужен инструмент, который будет искать токсичные комментарии пользователей о товарах и отправлять их на модерацию | pandas, tqdm, torch, GridSearchCV, transformers, CatBoostClassifier, LGBMClassifier |
